...
impl<'a> _READYW<'a> {
    ...
    pub fn disabled(self) -> &'a mut W {
        self.variant(READYW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(READYW::ENABLED)
    }
...
impl<'a> _DOWNW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(DOWNW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(DOWNW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> _UPW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(UPW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(UPW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> _CROSSW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(CROSSW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(CROSSW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
