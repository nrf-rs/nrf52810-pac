...
#[doc = "Values that can be written to the field `TASKS_RATEOVERRIDE`"]
pub enum TASKS_RATEOVERRIDEW {
    #[doc = "Trigger task"]
    TRIGGER,
}
impl TASKS_RATEOVERRIDEW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            TASKS_RATEOVERRIDEW::TRIGGER => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _TASKS_RATEOVERRIDEW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: TASKS_RATEOVERRIDEW) -> &'a mut W {
        {
    ...
    pub fn trigger(self) -> &'a mut W {
        self.variant(TASKS_RATEOVERRIDEW::TRIGGER)
    }
